...
![VPC Creation: Configuration of StudentApp-VPC with 10.0.0.0/16 CIDR block]({{ site.baseurl }}/assets/img/posts/aws1/1.png)
...
![Public Subnet Creation in Availability Zone us-east-1a]({{ site.baseurl }}/assets/img/posts/aws1/1b.png)
...
![Internet Gateway Creation and Attachment]({{ site.baseurl }}/assets/img/posts/aws1/1c.png)
...
![Route Table Configuration with Default Route to IGW]({{ site.baseurl }}/assets/img/posts/aws1/1d.png)
...
![Subnet Association with Route Table]({{ site.baseurl }}/assets/img/posts/aws1/1e.png)
...
![Select Ubuntu AMI and Instance Type]({{ site.baseurl }}/assets/img/posts/aws1/2.png)
...
![Configure Network Settings and Security Group]({{ site.baseurl }}/assets/img/posts/aws1/2b.png)
...
![Add User Data Script]({{ site.baseurl }}/assets/img/posts/aws1/2c.png)
...
![Instance Running with Status Checks Passed]({{ site.baseurl }}/assets/img/posts/aws1/2d.png)
...
![Student Records Application Running]({{ site.baseurl }}/assets/img/posts/aws1/3.png)
...
![Add Student Record]({{ site.baseurl }}/assets/img/posts/aws1/3b.png)

![Modify and Delete Records]({{ site.baseurl }}/assets/img/posts/aws1/3c.png)

![Verify Records Updated]({{ site.baseurl }}/assets/img/posts/aws1/3d.png)
...
![Create Private Subnet in AZ-1]({{ site.baseurl }}/assets/img/posts/aws1/4.png)
...
![Create Private Subnet in AZ-2]({{ site.baseurl }}/assets/img/posts/aws1/4b.png)
...
![Create DB Subnet Group]({{ site.baseurl }}/assets/img/posts/aws1/5.png)
...
![Configure RDS Instance]({{ site.baseurl }}/assets/img/posts/aws1/6.png)

![RDS Database Created Successfully]({{ site.baseurl }}/assets/img/posts/aws1/6b.png)
...
![RDS Security Group Inbound Rule]({{ site.baseurl }}/assets/img/posts/aws1/7.png)
...
![Create Cloud9 Environment]({{ site.baseurl }}/assets/img/posts/aws1/8.png)

![Cloud9 Environment Details]({{ site.baseurl }}/assets/img/posts/aws1/8b.png)
...
![Cloud9 IDE with Terminal Ready]({{ site.baseurl }}/assets/img/posts/aws1/9.png)
...
![Upload Scripts to Cloud9]({{ site.baseurl }}/assets/img/posts/aws1/10.png)
...
![Secret Creation Command with Values]({{ site.baseurl }}/assets/img/posts/aws1/10b.png)
...
![Secret Created in Secrets Manager]({{ site.baseurl }}/assets/img/posts/aws1/10c.png)
...
![Launch Web Server EC2 Instance]({{ site.baseurl }}/assets/img/posts/aws1/11.png)

![Configure Network and IAM Role]({{ site.baseurl }}/assets/img/posts/aws1/11b.png)

![Instance Running with Public IP]({{ site.baseurl }}/assets/img/posts/aws1/11c.png)
...
![Target Group Configuration]({{ site.baseurl }}/assets/img/posts/aws1/16.png)
...
![Instance Registration with Target Group]({{ site.baseurl }}/assets/img/posts/aws1/16b.png)
...
![Load Balancer Configuration - Network Mapping]({{ site.baseurl }}/assets/img/posts/aws1/17.png)
...
![Load Balancer Listener Configuration]({{ site.baseurl }}/assets/img/posts/aws1/17b.png)
...
![Creating AMI from Running Instance]({{ site.baseurl }}/assets/img/posts/aws1/15.png)

![AMI Successfully Created and Available]({{ site.baseurl }}/assets/img/posts/aws1/15b.png)
...
![Auto Scaling Group Configuration and Scaling Policy]({{ site.baseurl }}/assets/img/posts/aws1/18.png)

![Auto Scaling Group Size and Capacity Settings]({{ site.baseurl }}/assets/img/posts/aws1/19.png)
...
![Auto Scaling Group Active with Multiple Instances Running]({{ site.baseurl }}/assets/img/posts/aws1/20.png)
...
![Application Accessed Through Load Balancer Endpoint]({{ site.baseurl }}/assets/img/posts/aws1/21.png)
...
![Load Testing Results from Cloud9]({{ site.baseurl }}/assets/img/posts/aws1/22.png)
